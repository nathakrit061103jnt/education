...
if (isset($_POST["submitResearch"])) {
     ...
     $sql = "INSERT INTO `research` (`R_id`, `Rautor`, `Ryear`, `Rtite`, `Rditor`,`Rtopic`, `Rdate`, `Rlocation`, `Rpublisher`, `Rpage`, `lec_id`) 
            VALUES (NULL, '{$_POST["Rautor"]}', '{$_POST["Ryear"]}',
             '{$_POST["Rtite"]}', '{$_POST["Rditor"]}', '{$_POST["Rtopic"]}',
              '{$_POST["Rdate"]}', '{$_POST["Rlocation"]}', '{$_POST["Rpublisher"]}',
               '{$_POST["Rpage"]}', '$lec_id');";
