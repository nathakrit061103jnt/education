...
if (isset($_GET["deleteResConfirm"])) {
    echo
    "<script> 
                        Swal.fire({
                            icon: 'warning',
                            ...
                            if (result.isConfirmed) {
                                location = 'form.php?deleteResAlert=req&lec_id={$_GET["lec_id"]}&R_id={$_GET["R_id"]}'
                            }else{
