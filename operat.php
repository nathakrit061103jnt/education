             ...
             <div class="row">
                 ...
                 <div class="col-sm-7 bg-Light">
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_A')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                        while ($row = mysqli_fetch_assoc($result_a)) { ?>
                     <span><?=$row["a_file"]?></span>
                     <br>
                     <?php    }
                    ?><br>
                 </div>
             ...
             <div class="row">
                 ...
                 <div class="col-sm-7 bg-Light">
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_B')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                    ...
                    ?><br>
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_C')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                    ...
                    ?><br>
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_D')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                    ...
                    ?><br>
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_E')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
             ...
             <div class="row">
                 ...
                 <div class="col-sm-7 bg-Light">
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_G')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                        while ($row = mysqli_fetch_assoc($result_g)) { ?>
                     <span><?=$row["g_file"]?></span>
                     <br>
                     <?php    }
                    ?><br>
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_H')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                        while ($row = mysqli_fetch_assoc($result_h)) { ?>
                     <span><?=$row["h_file"]?></span>
                     <br>
                     <?php    }
                    ?><br>
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_I')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                        while ($row = mysqli_fetch_assoc($result_i)) { ?>
                     <span><?=$row["i_file"]?></span>
                     <br>
                     <?php    }
                    ?><br>
                 </div>
             ...
             <div class="row">
                 ...
                 <div class="col-sm-7 bg-Light">
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_J')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                        while ($row = mysqli_fetch_assoc($result_j)) { ?>
                     <span><?=$row["j_file"]?></span>
                     <br>
                     <?php    }
                    ?><br>
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_K')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                    ...
                    ?><br>
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_L')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                    ...
                    ?><br>
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_M')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
             ...
             <div class="row">
                 ...
                 <div class="col-sm-7 bg-Light">
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_N')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                    ...
                    ?><br>
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_O')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                    ...
                    ?><br>
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_P')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                    ...
                    ?><br>
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_Q')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
                    ...
                    ?><br>
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_R')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
             ...
             <div class="row">
                 ...
                 <div class="col-sm-7 bg-Light">
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_S')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
             ...
             <div class="row">
                 ...
                 <div class="col-sm-7 bg-Light">
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_T')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
             ...
             <div class="row">
                 ...
                 <div class="col-sm-7 bg-Light">
                     ...
                     <form method="post" @submit.prevent="uploadImage">
                         ...
                         <input type="file" @change="convertImagesBase64" required>
                         <button class="btn btn-secondary" @click="actionFunc('upload_image_U')" type="submit"
                             name="submitInsertData">upload</button>
                         <br>
                     </form>
                     <?php
     ...
     <center>
         ...
         <center>
            ...
            ?>
             ...
             <?php if(!isset($_SESSION['ses_aid'])){ ?>
             <div id="app">
                 <a href=" data.php" class="btn btn-info"><i class='fas fa-home' style='font-size:20px'></i>
                     กลับไปหน้าหลัก</a>
                 <center>
                     <h1>ขั้นตอนการปฎิบัติงานการปรับปรุงหลักสูตร<h1>
                 </center>
                         ...
                         <div class="col-4 bg-primary text-white p-3">
                             <center>
                                 <p class="bg-primary text-white">
                                     สรุปข้อมูลการดำเนินงานปรับปรุงหลักสูตรเสนอผู้บริหารคณะฯ</p>
                             </center>
             ...
             <center>
                 ...
                 <a href="data.php" id="button1id" name="button1id" class="btn btn-success">กลับไปหน้าแรก</a>
                 <center>
                     <?php
                        include_once "./docScript.php"; 
                    ?>
