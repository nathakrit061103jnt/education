 ...
 <body>
     <div id="app">
         <a href="operat.php" class="btn btn-info">
             <i class='fas fa-angle-double-left' style='font-size:20px'> </i> กลับไปหน้าแรก
         </a>
         <center>
     ...
     <center>
         <a href="operat.php" class="btn btn-info"><i class='fas fa-angle-double-left' style='font-size:20px'> </i>
             กลับไปหน้าแรก</a>
         <a href="data.php" id="button1id" name="button1id" class="btn btn-success"><i class='fas fa-home'
                 style='font-size:20px'></i> ไปหน้าหลัก</a>
         <center>
             <?php
