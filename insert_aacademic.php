...
if (isset($_POST["submitAacademic"])) {
     ...
     $sql = "INSERT INTO `aacademic` (`A_id`, `Aautor`, `Ayear`, `Atite`, `Atite_jour`, `Avolune`, `Apage`, `lec_id`) 
            VALUES (NULL, '{$_POST["Aautor"]}', '{$_POST["Ayear"]}', '{$_POST["Atite"]}',
             '{$_POST["Atite_jour"]}', '{$_POST["Avolune"]}', '{$_POST["Apage"]}', '$lec_id');";
